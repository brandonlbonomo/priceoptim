...
export const properties: Property[] = [
  ...
  },
  {
    ...
    description:
      "The Gorge Getaway is a freshly updated 2-bedroom, 2-bathroom vacation home in Niagara Falls, New York. Perfect for families visiting Niagara Falls State Park, Whirlpool State Park, and the Niagara Gorge Discovery Center. This clean, modern space offers a full kitchen, laundry, fast Wi-Fi, free parking, and a quiet neighborhood setting — all within a short drive of Clifton Hill, Seneca Niagara Casino, and the Outlet Collection at Niagara. Book your Niagara Falls vacation rental directly with Bonomo Capital Group for the best rate guaranteed.",
    location: {
      city: "Niagara Falls",
      state: "NY",
      area: "Niagara Falls",
  ...
  },
  {
    ...
    amenities: [
      ...
      { name: "Fresh Towels", category: "bathroom", icon: "Bath" },
      { name: "Linens Provided", category: "bedroom", icon: "Bed" },
      { name: "Pet Friendly", category: "essentials", icon: "PawPrint" },
    ],
    houseRules: [
      "No smoking",
      "No parties or events",
